...
در صورتی که کاربر ایجاد شد و در جدول کاربران در پنل نمایش داده نشد و قصد حذف کاربر را داشتید از دستور delluser usernsme  به جای usernemae  نام کاربر را وارد کنید.
